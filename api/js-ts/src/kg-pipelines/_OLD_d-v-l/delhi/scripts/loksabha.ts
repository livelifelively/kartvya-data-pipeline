...
(async () => {
  ...
  const loksabhaConstituenciesList = [
    {
      names: ["Chandni Chowk"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Chandni_Chowk_Lok_Sabha_constituency",
    },
    {
      names: ["North East Delhi"],
      wikipedia_page: "https://en.wikipedia.org/wiki/North_East_Delhi_Lok_Sabha_constituency",
    },
    {
      names: ["East Delhi"],
      wikipedia_page: "https://en.wikipedia.org/wiki/East_Delhi_Lok_Sabha_constituency",
    },
    {
      names: ["New Delhi"],
      wikipedia_page: "https://en.wikipedia.org/wiki/New_Delhi_Lok_Sabha_constituency",
    },
    {
      names: ["North West Delhi"],
      wikipedia_page: "https://en.wikipedia.org/wiki/North_West_Delhi_Lok_Sabha_constituency",
    },
    {
      names: ["West Delhi"],
      wikipedia_page: "https://en.wikipedia.org/wiki/West_Delhi_Lok_Sabha_constituency",
    },
    {
      names: ["South Delhi"],
      wikipedia_page: "https://en.wikipedia.org/wiki/South_Delhi_Lok_Sabha_constituency",
    },
  ];
