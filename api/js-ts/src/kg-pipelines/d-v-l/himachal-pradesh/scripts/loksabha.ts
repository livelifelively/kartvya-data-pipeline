...
(async () => {
  ...
  const loksabhaConstituenciesList = [
    {
      names: ["Kangra"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Kangra_Lok_Sabha_constituency",
    },
    {
      names: ["Mandi"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Mandi_Lok_Sabha_constituency",
    },
    {
      names: ["Hamirpur"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Hamirpur,_Himachal_Pradesh_Lok_Sabha_constituency",
    },
    {
      names: ["Shimla"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Shimla_Lok_Sabha_constituency",
    },
  ];
