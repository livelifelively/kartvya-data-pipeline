// TODO FIXME ladakh OSM has issues. till this version it had difference w.r.t. the current version for districts
// update later when we have changes added to OSM.
