...
(async () => {
  ...
  const loksabhaConstituenciesList = [
    {
      names: ["Sarguja"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Sarguja_Lok_Sabha_constituency",
    },
    {
      names: ["Raigarh"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Raigarh_Lok_Sabha_constituency",
    },
    {
      names: ["Janjgir–Champa"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Janjgir%E2%80%93Champa_Lok_Sabha_constituency",
    },
    {
      names: ["Korba"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Korba_Lok_Sabha_constituency",
    },
    {
      names: ["Bilaspur"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Bilaspur_Lok_Sabha_constituency",
    },
    {
      names: ["Rajnandgaon"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Rajnandgaon_Lok_Sabha_constituency",
    },
    {
      names: ["Durg"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Durg_Lok_Sabha_constituency",
    },
    {
      names: ["Raipur"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Raipur_Lok_Sabha_constituency",
    },
    {
      names: ["Mahasamund"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Mahasamund_Lok_Sabha_constituency",
    },
    {
      names: ["Bastar"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Bastar_Lok_Sabha_constituency",
    },
    {
      names: ["Kanker"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Kanker_Lok_Sabha_constituency",
    },
  ];
