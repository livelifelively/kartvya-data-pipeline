...
(async () => {
  ...
  const loksabhaConstituenciesList = [
    {
      names: ["Arunachal West"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Arunachal_West_Lok_Sabha_constituency",
    },
    {
      names: ["Arunachal East"],
      wikipedia_page: "https://en.wikipedia.org/wiki/Arunachal_East_Lok_Sabha_constituency",
    },
  ];
